...
import { gudgenby_stations } from '~/data/waterdata-stations';

const GudgenbyRiverMenu = forwardRef<HTMLButtonElement, { close: () => void }>(({ close }, ref) => {
  return (
    <Menu
      trigger="click-hover"
      loop={false}
...
GudgenbyRiverMenu.displayName = 'GudgenbyRiverMenu';

export default GudgenbyRiverMenu;
