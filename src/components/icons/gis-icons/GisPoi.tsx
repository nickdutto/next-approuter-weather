...
const GisPoi = (props: IconSvgProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="#222226"
        d="M50.002 16.354c10.359 0 18.597 8.218 18.597 18.548c0 10.33-8.238 18.544-18.597 18.544c-10.36 0-18.601-8.215-18.601-18.544c0-10.33 8.241-18.548 18.6-18.548z"
      ></path>
    </svg>
  );
};

export default GisPoi;
